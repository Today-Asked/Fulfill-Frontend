      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5 flex-1">
        ...
        <div className="flex justify-center gap-5">
          ...
          <button
            ...
            onClick={() => setError("尚未開放使用 Google 登入，敬請期待")}
            aria-label="Google 登入"
            aria-disabled="true"
            title="暫時無法使用"
            className="w-14 h-14 rounded-full bg-white/8 border border-white/12 flex items-center justify-center opacity-40 cursor-not-allowed transition-all"
          >
          ...
          <button
            type="button"
            onClick={() => setError("尚未開放使用 Facebook 登入，敬請期待")}
